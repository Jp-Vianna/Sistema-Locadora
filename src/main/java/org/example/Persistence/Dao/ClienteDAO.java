...
import org.example.Persistence.InterfaceDAO.IClienteDAO;
import org.example.Persistence.Connection.DBConnection;
import org.example.Persistence.Mapper.ClienteMapper;
...
public class ClienteDAO implements IClienteDAO {
     ...
     */
    @Override
    public List<ClienteDTO> findAll(String tipo) throws SQLException  {
        String sql;

        if(tipo.equals("C"))
            sql = "select * from clientes order by cpf";
        else
