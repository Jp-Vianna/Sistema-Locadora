package org.example.UI.ClienteUI.Cadastrar;
...
import org.example.Usecases.ClienteCtrl.CadastroClienteCtrl;
import org.example.Usecases.Request.ClienteRequest;

/**
 * Classe que controla a entrada de dados e dispara a funcionalidade de cadastro dos clientes
 */
public class CadastroClientePrt implements PresenterClass {
