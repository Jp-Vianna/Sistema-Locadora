...
public class MenuView {
    ...
    private enum TipoMenu { PRINCIPAL,
        CLIENTE,
        VEICULO,
        LOCACAO }
    ...
    public Opcao getOpcao() {
        ...
        for (;;) {
            ...
            switch (opcao) {
                case  1: menu = TipoMenu.CLIENTE; break;
                case  2: menu = TipoMenu.VEICULO; break;
                case  3: menu = TipoMenu.LOCACAO; break;
                case  4: return Opcao.FIM;
                case 11: return Opcao.CADASTRAR_CLIENTE;
                case 12: return Opcao.EXCLUIR_CLIENTE;
                case 13: return Opcao.LISTAR_CLIENTE;
                case 21: return Opcao.CADASTRAR_VEICULO;
                case 22: return Opcao.EXCLUIR_VEICULO;
                case 23: return Opcao.LISTAR_VEICULO;
                case 31: return Opcao.LOCAR_VEICULO;
                case 32: menu = TipoMenu.PRINCIPAL; break;
                case 33: return Opcao.LISTAR_LOCACAO;
                case 14:
                case 24:
                case 34: menu = TipoMenu.PRINCIPAL; break;
            }
        }
    }
